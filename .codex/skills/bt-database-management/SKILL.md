...
7. Dataset 作成では `providerVintage` と manifest payload `schemaVersion: 4` を検証する。
...
- Market v4以前や adjustment mode 不一致は unsupported として扱い、compatibility fallback を足さない。

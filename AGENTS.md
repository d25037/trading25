...
- cutover report / backup / staging / quarantine identity は `operations/market-v5-cutover` のみを使う。failure artifact と immutable backup は保持し、operator は operation lock / staging を手動変更せず、unjoined child の ownership 解決前に rollback を強行しない

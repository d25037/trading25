...
この readout は bundle `/private/tmp/trading25-research/market-behavior/post-earnings-next-day-entry/20260516_post_earnings_next_day_liquidity_z_v2` に基づく。入力 DB は `~/.local/share/trading25/market-timeseries/market.duckdb`、対象は `2016-04-01` から `2026-05-14`。
...
- latest result bundle: `~/.local/share/trading25/research/market-behavior/post-earnings-next-day-entry/20260516_overheat_adjusted_sot`

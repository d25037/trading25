...
#### 結論: average sector score を production に採用する
...
- `sector_strength_score` は `sector_index_strength_score` と `sector_constituent_strength_score` の平均とし、Daily Ranking では `Sector Score` として表示する。

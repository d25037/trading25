...
#### 結論: average sector strength を production に採用する
...
- Bundle v4 index-score reference: `~/.local/share/trading25/research/market-behavior/ranking-sector-strength-evidence/20260601_ranking_sector_strength_index_score_v4/`
- Bundle v5 average-score adopted: `~/.local/share/trading25/research/market-behavior/ranking-sector-strength-evidence/20260601_ranking_sector_strength_average_score_v5/`
...
- `sector_strength_score` は `sector_index_strength_score` と `sector_constituent_strength_score` の平均とし、Daily Ranking では `Balanced Sector Strength` として表示する。

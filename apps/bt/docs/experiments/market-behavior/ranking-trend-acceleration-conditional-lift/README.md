...
Published run `20260719_prime_price_pit_conditional_lift_v8` は clean source commit `85140932d6b785b41069db3ef7afe1d066cb0d5e` (`git_dirty=false`) から再実行した。銘柄固有の実completion dateでshared panelが計算したN225 excessを、5D / 20D / 60Dすべてで最終observation bundleにも透過し、overlap membership、event-time adjustment frontier、Top-K outcome coverageとfrozen gateを維持している。continuous `1 / 7`、binary `0 / 7`、`reject_introduction`という最終判断は変わらない。
...
v8の`topk_priority_lift_df`は23,363 complete rowsと220 `incomplete_outcomes` rowsを区別する。未完了outcomeを暗黙に成績0へ変換しないaligned-outcome集計でも、published lift、CI、gate verdictは上記のままである。
...
v8はcompletion-aligned outcomeを最終artifactまで保存したcanonical evidenceであり、旧v2–v7はimmutable archiveとして保持する。
...
- Durable bundle: `~/.local/share/trading25/research/market-behavior/ranking-trend-acceleration-conditional-lift/20260719_prime_price_pit_conditional_lift_v8/`
- Manifest: `~/.local/share/trading25/research/market-behavior/ranking-trend-acceleration-conditional-lift/20260719_prime_price_pit_conditional_lift_v8/manifest.json`
- Results: `~/.local/share/trading25/research/market-behavior/ranking-trend-acceleration-conditional-lift/20260719_prime_price_pit_conditional_lift_v8/results.duckdb`
- Summary: `~/.local/share/trading25/research/market-behavior/ranking-trend-acceleration-conditional-lift/20260719_prime_price_pit_conditional_lift_v8/summary.md`
- Provenance: source commit `85140932d6b785b41069db3ef7afe1d066cb0d5e`; `git_dirty=false`。artifact SHA-256はmanifest `b8f5023fe8de2866c99644103de9e28d0e1c08ffe7eb108d6fd331336d8b21e6`、results `fe12987b39f5aa03abb85fff32f3836f5b4ab2b5d51b89f45fe924fcbc498338`、summary `a11c14bc044d91cacf860a0dec97c6b02329408bc73043fa642e5270edd95ebd`。
- Superseded immutable archives: v2–v7 bundleは削除・上書きせず保持する。
...
uv run --project apps/bt python \
  ...
  --run-id 20260719_prime_price_pit_conditional_lift_v8
```

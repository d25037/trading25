...
- latest result bundle: `/tmp/trading25-research/market-behavior/recent-return-threshold-forward-response/20260518_recent_return_threshold_forward_response_prime_value_interaction_v1`
- result tables: `coverage_diagnostics_df`, `threshold_response_df`, `joint_threshold_response_df`, `percentile_response_df`, `valuation_response_df`, `valuation_interaction_df`, `nonoverlap_response_df`, `annual_threshold_response_df`, `liquidity_interaction_df`, `observation_sample_df`

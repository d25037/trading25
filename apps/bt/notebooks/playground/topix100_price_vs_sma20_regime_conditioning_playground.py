...
@app.cell
def _(get_latest_bundle_defaults, get_topix100_price_vs_sma20_regime_conditioning_latest_bundle_path):
...
def _(
    ...
    run_id, bundle_path, controls_view = build_bundle_viewer_controls(
        ...
        runner_path="apps/bt/scripts/research/run_topix100_price_vs_sma20_regime_conditioning.py",
    )
    controls_view
...
def _(
    ...
    try:
        bundle_info, result = load_bundle_selection(
            ...
            load_research_bundle=load_topix100_price_vs_sma20_regime_conditioning_research_bundle,
        )
        error_message = None

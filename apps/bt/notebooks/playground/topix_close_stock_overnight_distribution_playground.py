...
@app.cell
def _(get_latest_bundle_defaults, get_topix_close_stock_overnight_distribution_latest_bundle_path):
...
def _(build_bundle_viewer_controls, latest_bundle_path_str, latest_run_id, mo):
    run_id, bundle_path, controls_view = build_bundle_viewer_controls(
        ...
        runner_path="apps/bt/scripts/research/run_topix_close_stock_overnight_distribution.py",
        docs_readme_path="apps/bt/docs/experiments/market-behavior/topix-close-stock-overnight/README.md",
    )
    controls_view
...
def _(
    ...
    try:
        bundle_info, result = load_bundle_selection(
            ...
            load_research_bundle=load_topix_close_stock_overnight_distribution_research_bundle,
        )
        error_message = None

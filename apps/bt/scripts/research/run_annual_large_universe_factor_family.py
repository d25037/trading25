#!/usr/bin/env python3
"""Runner-first entrypoint for annual large-universe factor-family research."""
...
from src.domains.analytics.annual_large_universe_factor_family import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Compare a broader fundamental factor family inside TOPIX100/TOPIX500 "
            "annual value universes, including low-forward-PER overlays."
        )
    )
    parser.add_argument(
        "--input-bundle",

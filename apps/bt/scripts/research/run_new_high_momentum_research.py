#!/usr/bin/env python3
"""Runner-first entrypoint for N-day new-high momentum research."""
...
from src.domains.analytics.new_high_momentum_research import (  # noqa: E402
    DEFAULT_HIGH_WINDOWS,
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run N-day new-high momentum research and persist a reproducible "
    ...
    parser.add_argument(
        "--high-windows",
        type=_parse_int_csv,
        default=DEFAULT_HIGH_WINDOWS,
        help="Comma-separated rolling high windows in trading days.",
    )
    parser.add_argument(
        "--horizons",
        type=_parse_int_csv,
    ...
    parser.add_argument(
        ...
        help="Deterministic event sample size per universe.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_new_high_momentum_research(
        ...
        high_windows=args.high_windows,

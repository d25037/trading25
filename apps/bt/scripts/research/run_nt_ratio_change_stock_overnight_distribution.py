#!/usr/bin/env python3
"""Runner-first entrypoint for NT ratio change / stock overnight distribution."""
...
from src.domains.analytics.nt_ratio_change_stock_overnight_distribution import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run NT ratio change / stock overnight distribution research and persist "

#!/usr/bin/env python3
"""Runner-first entrypoint for post-earnings next-day entry research."""
...
from src.domains.analytics.post_earnings_next_day_entry import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run PIT-safe post-earnings next-day entry research with stop-limit "
    ...
    parser.add_argument(
        ...
        help="Comma-separated forward post-entry horizons in trading sessions.",
    )
    parser.add_argument(
        "--liquidity-window",
        type=int,
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_post_earnings_next_day_entry_research(
        args.db_path,

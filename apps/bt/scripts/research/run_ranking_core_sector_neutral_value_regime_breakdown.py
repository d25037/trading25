#!/usr/bin/env python3
"""Runner-first entrypoint for sector-neutral value regime breakdown research."""
...
from src.domains.analytics.ranking_core_sector_neutral_value_regime_breakdown import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Re-run the annual Ranking factor breakdown with sector-neutral value "
            "definitions to test whether bank-dependent value returns can be "
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_ranking_core_sector_neutral_value_regime_breakdown_research(
        args.db_path,

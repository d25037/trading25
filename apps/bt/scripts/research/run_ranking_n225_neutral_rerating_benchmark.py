#!/usr/bin/env python3
"""Runner-first entrypoint for N225-neutral-rerating Daily Ranking research."""
...
from src.domains.analytics.ranking_n225_neutral_rerating_benchmark import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Daily Ranking neutral-rerating evidence with Nikkei 225 "
    ...
    parser.add_argument(
        ...
        help="Comma-separated liquidity regimes to include. Defaults to neutral_rerating.",
    )
    parser.add_argument(
        "--min-observations",
        type=int,

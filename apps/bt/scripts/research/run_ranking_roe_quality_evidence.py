#!/usr/bin/env python3
"""Runner-first entrypoint for Ranking ROE/FwdROE quality evidence."""
...
from src.domains.analytics.ranking_roe_quality_evidence import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run PIT-safe Daily Ranking evidence for ROE and FwdROE "
            "quality percentiles."
        )
    )
    parser.add_argument(
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_ranking_roe_quality_evidence_research(
        args.db_path,

#!/usr/bin/env python3
"""Runner-first entrypoint for Ranking sector-strength evidence."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run PIT-safe 33-sector strength evidence for Daily Ranking "
            "crowded/neutral rerating green/blue signals."
        )
    )
    parser.add_argument(
        "--db-path",

#!/usr/bin/env python3
"""Runner-first entrypoint for SMA5 below-streak evidence research."""
...
from src.domains.analytics.ranking_sma5_below_streak_evidence import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Daily Ranking evidence for cases where close is below SMA5 "
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_ranking_sma5_below_streak_evidence_research(
        args.db_path,

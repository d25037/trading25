#!/usr/bin/env python3
"""Runner-first entrypoint for SMA5 count long-side evidence research."""
...
from src.domains.analytics.ranking_sma5_count_long_evidence import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Daily Ranking long-side evidence for the count of days, "
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_ranking_sma5_count_long_evidence_research(
        args.db_path,

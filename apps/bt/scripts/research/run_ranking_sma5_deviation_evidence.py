#!/usr/bin/env python3
"""Runner-first entrypoint for Daily Ranking SMA5 deviation evidence."""
...
from src.domains.analytics.ranking_sma5_deviation_evidence import (  # noqa: E402
    DEFAULT_HORIZONS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Daily Ranking evidence for close deviation from SMA5, "
            "bucketed as a short-term overheat/timing diagnostic."
        )
    )
    parser.add_argument(
        "--db-path",
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_ranking_sma5_deviation_evidence_research(
        args.db_path,

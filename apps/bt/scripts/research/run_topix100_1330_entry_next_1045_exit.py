#!/usr/bin/env python3
"""Runner-first entrypoint for TOPIX100 13:30 entry to next 10:45 exit research."""
...
from src.domains.analytics.topix100_1330_entry_next_1045_exit import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX100 13:30 entry to next-session 10:45 exit research and "

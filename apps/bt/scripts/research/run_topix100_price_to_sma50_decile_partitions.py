#!/usr/bin/env python3
"""Runner-first entrypoint for TOPIX100 price/SMA50 decile partition research."""
...
from src.domains.analytics.topix100_price_to_sma50_decile_partitions import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX100 price/SMA50 decile partition research and persist a "

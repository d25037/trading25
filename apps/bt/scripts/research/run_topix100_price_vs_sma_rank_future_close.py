#!/usr/bin/env python3
"""Runner-first entrypoint for TOPIX100 price-vs-SMA research."""
...
from src.domains.analytics.topix100_price_vs_sma_rank_future_close import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX100 price-vs-SMA research and persist a reproducible "

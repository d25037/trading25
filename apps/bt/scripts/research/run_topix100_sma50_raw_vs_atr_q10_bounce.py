#!/usr/bin/env python3
"""Runner-first entrypoint for TOPIX100 SMA50 raw-vs-ATR Q10 bounce research."""
...
from src.domains.analytics.topix100_sma50_raw_vs_atr_q10_bounce import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX100 SMA50 raw-vs-ATR Q10 bounce research and persist a "
    ...
    parser.add_argument(
        "--start-date", default=None, help="Analysis start date (YYYY-MM-DD)."
    )
    parser.add_argument(
        "--end-date", default=None, help="Analysis end date (YYYY-MM-DD)."
    )
    parser.add_argument(
        "--lookback-years",
        type=int,

#!/usr/bin/env python3
"""Runner-first entrypoint for TOPIX100 SMA-ratio regime conditioning research."""
...
from src.domains.analytics.topix100_sma_ratio_regime_conditioning import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX100 SMA-ratio regime conditioning research and persist a "

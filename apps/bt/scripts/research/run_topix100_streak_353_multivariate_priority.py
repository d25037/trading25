"""Run the TOPIX100 streak 3/53 multivariate priority study and persist a bundle."""
...
from src.domains.analytics.topix100_streak_353_multivariate_priority import (  # noqa: E402
    DEFAULT_FUTURE_HORIZONS,
    DEFAULT_MIN_DISCOVERY_DATE_COUNT,
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the TOPIX100 streak 3/53 multivariate priority study and persist "
            "a reproducible bundle under ~/.local/share/trading25/research/."
        )
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=DEFAULT_MIN_DISCOVERY_DATE_COUNT,
    )
    parser.add_argument(
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = run_topix100_streak_353_multivariate_priority_research(
        ...
        min_discovery_date_count=args.min_discovery_date_count,

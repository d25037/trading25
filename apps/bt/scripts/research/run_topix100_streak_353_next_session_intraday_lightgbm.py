"""Run the TOPIX100 streak 3/53 next-session intraday LightGBM study."""
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the TOPIX100 streak 3/53 next-session intraday LightGBM "
            "study and persist a reproducible bundle under "

"""Run the TOPIX100 next-session open-to-close 5D LightGBM walk-forward study."""
...
from src.domains.analytics.topix100_streak_353_next_session_open_to_close_5d_lightgbm_walkforward import (  # noqa: E402
    DEFAULT_WALKFORWARD_STEP,
    DEFAULT_WALKFORWARD_TEST_WINDOW,
    DEFAULT_WALKFORWARD_TRAIN_WINDOW,
    run_topix100_streak_353_next_session_open_to_close_5d_lightgbm_walkforward_research,
    write_topix100_streak_353_next_session_open_to_close_5d_lightgbm_walkforward_research_bundle,
)
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the TOPIX100 next-session open-to-close 5D LightGBM "
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = run_topix100_streak_353_next_session_open_to_close_5d_lightgbm_walkforward_research(
        args.db_path,

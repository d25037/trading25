"""Run the TOPIX100 next-session open-to-open 5D LightGBM walk-forward study."""
...
from src.domains.analytics.topix100_streak_353_next_session_open_to_open_5d_lightgbm_walkforward import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the TOPIX100 next-session open-to-open 5D LightGBM "
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = run_topix100_streak_353_next_session_open_to_open_5d_lightgbm_walkforward_research(
        args.db_path,

"""Run the TOPIX100 streak 3/53 score LightGBM walk-forward study."""
...
from src.domains.analytics.topix100_streak_353_signal_score_lightgbm_walkforward import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the TOPIX100 streak 3/53 score LightGBM walk-forward study "
            "and persist a reproducible bundle."
        )
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = run_topix100_streak_353_signal_score_lightgbm_walkforward_research(
        args.db_path,
    ...
    bundle = write_topix100_streak_353_signal_score_lightgbm_walkforward_research_bundle(
        result,

"""Run the TOPIX100 strongest-setup vs Q10 threshold study and persist a bundle."""
...
from src.domains.analytics.topix100_strongest_setup_q10_threshold import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the TOPIX100 strongest-setup vs Q10 threshold study and persist "

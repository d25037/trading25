"""Run TOPIX extreme close-to-close mode research and persist a research bundle."""
...
DEFAULT_CANDIDATE_WINDOW_SPEC = f"{DEFAULT_CANDIDATE_WINDOWS[0]}:{DEFAULT_CANDIDATE_WINDOWS[-1]}"
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX extreme close-to-close mode research and persist a reproducible "
    ...
    parser.add_argument(
        ...
        help=(
            "Comma-separated integers and/or inclusive ranges. "
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = run_topix_extreme_close_to_close_mode_research(
        ...
        min_mode_days=args.min_mode_days,
    )

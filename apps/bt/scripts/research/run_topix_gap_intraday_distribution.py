#!/usr/bin/env python3
"""Runner-first entrypoint for TOPIX gap / intraday distribution research."""
...
from src.domains.analytics.topix_gap_intraday_distribution import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX gap / intraday distribution research and persist a "
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="TOPIX gap lower sigma threshold.",
    )
    parser.add_argument(
        "--sigma-threshold-2",
        type=float,
        default=2.0,
        help="TOPIX gap upper sigma threshold.",
    )
    parser.add_argument(
        "--selected-groups",
        default=None,

"""Run TOPIX streak extreme mode research and persist a research bundle."""
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run TOPIX streak extreme mode research and persist a reproducible "
    ...
    parser.add_argument(
        ...
        help="Comma-separated future horizons in calendar trading days from streak end. Example: 1,5,10,20.",
    )
    parser.add_argument(
        "--validation-ratio",
        type=float,

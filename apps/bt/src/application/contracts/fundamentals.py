"""Application contracts for fundamentals queries and responses."""
...
class FundamentalsComputeQuery(BaseModel):
    """Application query for fundamentals computation."""
    ...
    def validate_date_range(self) -> FundamentalsComputeQuery:
        if (

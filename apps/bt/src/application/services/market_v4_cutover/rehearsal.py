...
class RehearsalMixin:
    ...
    def _rehearse_retained_under_lease(
        ...
        *,
        ...
        try:
            market_fd, source_market_identity_before = (
            ...
            identity_after = self._unchanged_market_tree_identity(
                lease.root_fd,
                source_market_identity_before,
            )
            source_market_identity_after = cast(dict[str, object], identity_after)
            if self.root_fingerprint(self.data_root) != target_root_fingerprint:
                raise _managed_root.CutoverSafetyError(
            ...
            report_path = self._publish_retained_rehearsal_report(
                report_id=report_id,
                started=started,
            ...
            self._handle_retained_rehearsal_failure(
                ...
                runtime_name=runtime_name,
                runtime_start_attempted=runtime_start_attempted,
                ...
                lease=lease,
                started=started,
                completed_api_checks=completed_api_checks,
    ...
    def _open_retained_market_for_rehearsal(
        ...
        try:
            ...
            return market_fd, self._market_tree_identity(lease.root_fd)
        except Exception:
            os.close(market_fd)
            raise

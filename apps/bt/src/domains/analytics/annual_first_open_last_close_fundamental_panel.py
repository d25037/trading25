...
from src.domains.analytics.annual_first_open_last_close_portfolio import (
    _annualized_sharpe,
    _annualized_sortino,
    _annualized_volatility_pct,
    build_annual_portfolio_daily_df,
...
def run_annual_first_open_last_close_fundamental_panel(
    ...
    *,
    ...
    annual_portfolio_daily_df = build_annual_portfolio_daily_df(
        event_ledger_df=event_ledger_df,
        price_df=price_df,
    )
    annual_portfolio_summary_df = build_annual_portfolio_summary_df(

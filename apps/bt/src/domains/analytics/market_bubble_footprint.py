...
BUBBLE_FOOTPRINT_EXPERIMENT_ID = "market-behavior/market-bubble-footprint"
...
def run_rerating_bubble_regime_forward_response_research(
    ...
    *,
    ...
    return ReratingBubbleRegimeResult(
        ...
        required_tables=tuple(dict.fromkeys((*_REQUIRED_TABLES, "ranking_color_panel"))),
...
def write_bubble_footprint_bundle(
    ...
    *,
    ...
    return write_research_bundle(
        experiment_id=BUBBLE_FOOTPRINT_EXPERIMENT_ID,
...
def write_rerating_bubble_regime_bundle(
    ...
    *,
    ...
    return write_research_bundle(
        experiment_id=RERATING_BUBBLE_REGIME_EXPERIMENT_ID,
        module="src.domains.analytics.market_bubble_footprint",

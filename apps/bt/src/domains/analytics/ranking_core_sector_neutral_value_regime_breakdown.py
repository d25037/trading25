    ...
    conn.executemany(
        ...
        [
            ...
            (
                ...
                "Valuation Signal",
                "Undervalued + Sector Score: Strong",
                30,
            ),
            (
                "sector_neutral_undervalued_sector_strong",
                "Valuation Signal",
                "Sector-Neutral Undervalued + Sector Score: Strong",
                40,
            ),
            ...
            (
                ...
                "Combined",
                "Sector-Neutral Momentum Value + Sector Score: Strong",
                80,
            ),
            (
                "hybrid_momentum_value_sector_strong",
                "Combined",
                "Hybrid Momentum Value + Sector Score: Strong",
                90,
            ),
            (
                "raw_and_sector_neutral_momentum_value_sector_strong",
                "Combined",
                "Raw + Sector-Neutral Momentum Value + Sector Score: Strong",
                100,
            ),
            (
                "sector_neutral_only_momentum_value_sector_strong",
                "Combined",
                "Sector-Neutral Only Momentum Value + Sector Score: Strong",
                110,
            ),
        ],
    )

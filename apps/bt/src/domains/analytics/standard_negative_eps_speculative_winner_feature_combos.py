...
from src.domains.analytics.standard_negative_eps_speculative_winner_feature_buckets import (
    FeatureSpec,
    _FEATURE_ORDER,
    _FEATURE_SPEC_BY_KEY,
    _FEATURE_SPECS,
    bucket_cfo_margin as _bucket_cfo_margin,
    bucket_entry_adv as _bucket_entry_adv,
    bucket_entry_market_cap as _bucket_entry_market_cap,
    bucket_entry_open as _bucket_entry_open,
    bucket_equity_ratio as _bucket_equity_ratio,
    bucket_pre_entry_volatility_20d as _bucket_pre_entry_volatility_20d,
    bucket_prior_20d_return as _bucket_prior_20d_return,
    bucket_prior_63d_return as _bucket_prior_63d_return,
    bucket_prior_252d_return as _bucket_prior_252d_return,
    bucket_profit_margin as _bucket_profit_margin,
    bucket_sector_name as _bucket_sector_name,
    bucket_volume_ratio_20d as _bucket_volume_ratio_20d,
    build_feature_bucket_def_df as _build_feature_bucket_def_df,
)
from src.domains.analytics.standard_negative_eps_speculative_winner_feature_report import (
...
_fmt_num = fmt_num
_top_summary_rows = top_summary_rows

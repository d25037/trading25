...
def _build_published_summary_payload(
    ...
    return {
        ...
        "method": [
            "Build the TOPIX100 streak 3 / 53 daily state panel and target each signal date with X+1 open -> X+6 open return; this historical bundle is invalidated because TOPIX100 membership was not date-effective.",

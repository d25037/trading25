...
コアロジックは src.shared.paths.resolver に統合済み。
...
from src.shared.paths import find_strategy_path as paths_find_strategy_path
from src.shared.paths.constants import SEARCH_ORDER
from src.shared.paths.resolver import (
    StrategyMetadata,

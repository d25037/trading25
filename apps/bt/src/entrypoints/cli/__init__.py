...
@app.command(name="market-maintain")
def market_maintain_command() -> None:
    """Run bounded-growth maintenance for the active Market DuckDB without syncing."""
    from src.entrypoints.cli.market import run_market_maintain_command

    run_market_maintain_command()

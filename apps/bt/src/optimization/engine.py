...
from src.constants import OPTIMIZATION_TIMEOUT_SECONDS
...
from src.strategies.utils.optimization import OptimizationResult
...
class ParameterOptimizationEngine:
    ...
    def _prefetch_data(
        ...
        if shared_config.relative_mode or shared_config.benchmark_table:
            try:
                from src.data import load_topix_data

...
def _build_market_db(db_path: Path) -> str:
    ...
    topix500_rows = [
        ...
        ("2024-01-05", "TOPIX500", "72030", None),
        ("2024-01-05", "TOPIX500", "22220", None),
        ("2024-01-08", "TOPIX500", "72030", None),
        ("2024-01-08", "TOPIX500", "22220", None),
    ]
    ...
    stock_master_rows = [
        ...
        ("2024-01-05", "72030", "0111", "TOPIX Large70"),
        ("2024-01-05", "11110", "0111", "-"),
        ("2024-01-05", "22220", "0111", "TOPIX Mid400"),
        ("2024-01-05", "33330", "0113", "-"),
        ("2024-01-08", "72030", "0111", "TOPIX Large70"),
        ("2024-01-08", "11110", "0111", "-"),
        ("2024-01-08", "22220", "0111", "TOPIX Mid400"),
        ("2024-01-08", "33330", "0113", "-"),
        ("2024-01-09", "72030", "0111", "TOPIX Large70"),
        ("2024-01-09", "11110", "0111", "-"),
        ("2024-01-09", "22220", "0111", "TOPIX Mid400"),
        ("2024-01-09", "33330", "0113", "-"),
    ]

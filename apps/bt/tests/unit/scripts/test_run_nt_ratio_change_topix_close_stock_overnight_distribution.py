...
def _load_module():
    ...
    if spec is None or spec.loader is None:
        raise RuntimeError("Failed to load joint overnight runner module")
    module = importlib.util.module_from_spec(spec)
    sys.modules["run_nt_ratio_change_topix_close_stock_overnight_distribution"] = module
...
def test_main_runs_joint_research_and_prints_bundle_payload(monkeypatch, capsys) -> None:
    module = _load_module()
    ...
    assert exit_code == 0
    assert payload["runId"] == "20260331_181200_testabcd"

...
def _load_module():
    return load_research_runner_module("run_topix100_price_vs_sma_rank_future_close.py")
...
def test_main_runs_research_and_prints_bundle_payload(monkeypatch, capsys) -> None:
    ...
    assert exit_code == 0
    assert_standard_bundle_payload(payload, run_id="20260331_120000_testabcd")

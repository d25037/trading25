      ...
      case 'chartSettings':
        return (
          <div className="space-y-2">
            ...
            <div className="space-y-1.5 rounded-xl border border-border/60 bg-[var(--app-surface-muted)] p-2.5">
        ...
        <div className="space-y-1.5">
          {SETTING_DIALOGS.map((dialog) => (
            <Button
              ...
              type="button"
              variant="outline"
              className="h-auto w-full justify-start border-border/60 bg-transparent px-3 py-2 hover:bg-[var(--app-surface-muted)]"
...
function ToggleRow({ id, icon: Icon, label, checked, onCheckedChange, meta }: ToggleRowProps) {
  return (
    <div className="flex items-start justify-between gap-2 rounded-xl border border-border/60 bg-[var(--app-surface-muted)] p-2.5">

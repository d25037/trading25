...
describe('routeSearch', () => {
  ...
  it('roundtrips ranking table filter search params', () => {
    const rankingSearch = validateRankingSearch({
      ...
      rankingFilterMinSma5AboveCount5d: '2',
      rankingFilterMaxSma5AboveCount5d: '5',
      rankingFilterMaxForwardPer: '18',
      rankingFilterMinForecastOperatingProfitGrowthRatio: '1.2',
    ...
    expect(rankingState.rankingTableFilters).toEqual({
      ...
      minChangePct: -2.5,
      minPer: 10,
      minSma5AboveCount5d: 2,
      maxSma5AboveCount5d: 5,
      maxForwardPer: 18,

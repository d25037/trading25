...
| `ranking_psr_valuation_evidence.py` | observed research-only | Evaluates actual FY sales PSR from `statements.sales` + `daily_valuation.market_cap`; not yet a persisted `daily_valuation` SoT column. |

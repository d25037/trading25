...
- 2026-03-24: `[test_routes_portfolio_factor_regression.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_portfolio_factor_regression.py)` と `[test_routes_portfolio_performance.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_portfolio_performance.py)` は test market fixture の 1 行ずつ `INSERT` を bulk `executemany` へ置き換え、portfolio analytics subset で `12 passed in 0.75s` を確認した。
...
- 2026-03-24: `[app.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/src/entrypoints/http/app.py)` に `_configure_http_app()` を切り出し、OpenAPI 設定・middleware・統一例外ハンドラを test 用の軽量 app からも再利用できるようにした。`create_app()` は本番用 lifespan を維持したままこの helper を使う形へ整理した。
- 2026-03-24: `[test_openapi.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_openapi.py)` は `FastAPI + _register_routes()` の route-only app に寄せ、`16 passed in 0.48s` を確認した。あわせて `[test_routes_dataset.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_dataset.py)` の create job 完了待ちを HTTP polling から `dataset_job_manager` の in-memory polling に切り替え、`12 passed in 0.56s` を確認した。
- 2026-03-24: `[test_routes_portfolio.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_portfolio.py)`、`[test_error_format.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_error_format.py)`、`[test_routes_portfolio_factor_regression.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_portfolio_factor_regression.py)`、`[test_routes_portfolio_performance.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_portfolio_performance.py)`、`[test_routes_watchlist.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_watchlist.py)`、`[test_routes_dataset_data.py](/Users/shinjiroaso/.codex/worktrees/3e53/trading25/apps/bt/tests/unit/server/test_routes_dataset_data.py)` は full `create_app()` をやめ、必要な router だけを載せた minimal app + `_configure_http_app()` に揃えた。

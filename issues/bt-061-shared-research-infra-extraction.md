...
- [ ] result codec / publication helper の重複候補が inventory 化されている。
- [ ] 追加抽出対象が次の slice として issue / code コメントなしで追える。
...
- [ ] result codec / publication helper の重複を次の slice で抽出する。
...
## 補足
- 親 issue: `bt-060`
- 次の候補: result codec / publication helper / latest bundle resolution helper
